...
class RejectFriendRequestResource(Resource):
    def post(self, user_id):
        ...
        try:
            ...
            own_friends_requests = current_user_db.friends_requests.split(",") if current_user_db.friends_requests else []
...
def init_api(api):
    ...
    api.add_resource(ChatResource, '/api/chats/create', '/api/chats/edit/<int:chat_id>', "/delete_private_chat/<chat_id>")
